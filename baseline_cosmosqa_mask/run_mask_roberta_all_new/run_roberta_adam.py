...
from baseline_cosmosqa_mask.run_mask_roberta_all_new.roberta_adam import train
from baseline_cosmosqa_mask.run_mask_roberta_all_new.roberta_adam import set_seed
...
def main():
    ...
    if args.model_choice == "large":
        ...
        args.model_name_or_path = os.path.join(grg_dir, "pretrained_model/_roberta-large")
    elif args.model_choice == "base":
        args.per_gpu_train_batch_size = 4
        args.per_gpu_eval_batch_size = 4
        args.model_name_or_path = os.path.join(grg_dir, "pretrained_model/_roberta-base")
    else:
        raise ValueError
