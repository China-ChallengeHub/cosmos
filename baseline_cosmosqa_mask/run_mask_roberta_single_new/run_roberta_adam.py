...
from baseline_cosmosqa_mask.run_mask_roberta_single_new.roberta_adam import train
from baseline_cosmosqa_mask.run_mask_roberta_single_new.roberta_adam import set_seed
...
def main():
    ...
    elif args.mask_type == "dependency":  # dependency mask 默认考虑从子节点到所有祖宗节点
