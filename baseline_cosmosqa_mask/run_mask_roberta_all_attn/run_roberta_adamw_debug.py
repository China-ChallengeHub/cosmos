...
from baseline_cosmosqa_mask.run_mask_roberta_all_attn.roberta_adamw_debug import train
from baseline_cosmosqa_mask.run_mask_roberta_all_attn.roberta_adamw_debug import set_seed
...
def main():
    ...
    if args.do_train:
        ...
        global_step, tr_loss, best_step = train(args, train_dataset, dev_dataset, roberta_model, transformer_model)
